    ...
    >
      <div className="relative aspect-video w-full overflow-hidden border-b border-border bg-muted/10">
        {thumbnail?.url ? (
          ...
          <div className="flex h-full w-full items-center justify-center text-muted font-mono text-sm">No image</div>
        )}

        {/* Overlay on hover */}
        {project.projectType === 'public' && (project.demoUrl || project.repositoryUrl) && (
      ...
      <div className="flex flex-col flex-1 p-5">
        ...
        <p className="text-muted text-sm flex-1 mb-4 line-clamp-3">{project.description}</p>
